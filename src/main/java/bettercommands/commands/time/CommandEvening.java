...
public class CommandEvening extends AbstractCommand {
	
	public CommandEvening() {
		super("evening", "bcommands.time.evening");
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		world.setTime(Config.getConfig().getLong("time.evening", 11000));
		sendMessage("time-set-evening", "%world%", world.getName());
		return true;
	}
