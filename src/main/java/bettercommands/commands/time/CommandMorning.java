...
public class CommandMorning extends AbstractCommand {
	
	public CommandMorning() {
		super("morning", "bcommands.time.morning");
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		world.setTime(Config.getConfig().getLong("time.morning", 23000));
		sendMessage("time-set-morning", "%world%", world.getName());
		return true;
	}
